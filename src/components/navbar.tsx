...
const GlassLink = ({ text }: { text: string }) => {
	return (
		<a href="/aboutme.tsx" className="group relative scale-100 overflow-hidden rounded-full px-4 py-2 transition-transform hover:scale-105 active:scale-95">
...
const TextLink = ({ text }: { text: string }) => {
	return (
		<a href="/aboutme.tsx" className="text-white/90 transition-colors hover:text-white">
			{text}
		</a>
	);
};
